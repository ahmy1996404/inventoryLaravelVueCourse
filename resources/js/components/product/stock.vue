<template>
    <div>
        <div class="row">
            <router-link to="/store-product" style="width:200px" class="btn btn-primary">
                Add Product
            </router-link>
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="product in filtersearch" :key="product.id" >
                        ...
                        <td>
                            <router-link :to="{name:'edit-stock' , params:{id:product.id}}"  class="btn btn-sm btn-primary"  style="color:white;" >Edit</router-link>
